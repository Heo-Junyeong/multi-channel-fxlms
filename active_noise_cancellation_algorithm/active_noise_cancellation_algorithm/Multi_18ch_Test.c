...
typedef struct primary_path
{
    short int p_1[PRI_PATH_LENGTH];
    short int p_2[PRI_PATH_LENGTH];
    short int p_3[PRI_PATH_LENGTH];
}primary_path_t;

typedef struct secondary_path
{
    short int s_11[SEC_PATH_LENGTH];
    short int s_12[SEC_PATH_LENGTH];
    short int s_13[SEC_PATH_LENGTH];
    short int s_21[SEC_PATH_LENGTH];
    short int s_22[SEC_PATH_LENGTH];
    short int s_23[SEC_PATH_LENGTH];
    short int s_31[SEC_PATH_LENGTH];
    short int s_32[SEC_PATH_LENGTH];
    short int s_33[SEC_PATH_LENGTH];
}secondary_path_t;

typedef struct primary_pathf
{
    dtype p_1f[PRI_PATH_LENGTH];
    dtype p_2f[PRI_PATH_LENGTH];
    dtype p_3f[PRI_PATH_LENGTH];
}primary_pathf_t;

typedef struct secondary_pathf
{
    dtype s_11f[SEC_PATH_LENGTH];
    dtype s_12f[SEC_PATH_LENGTH];
    dtype s_13f[SEC_PATH_LENGTH];
    dtype s_21f[SEC_PATH_LENGTH];
    dtype s_22f[SEC_PATH_LENGTH];
    dtype s_23f[SEC_PATH_LENGTH];
    dtype s_31f[SEC_PATH_LENGTH];
    dtype s_32f[SEC_PATH_LENGTH];
    dtype s_33f[SEC_PATH_LENGTH];
}secondary_pathf_t;

primary_path_t p[6] = { 0, };
secondary_path_t s[6] = { 0, };

primary_pathf_t p[6] = { 0, };
secondary_pathf_t s[6] = { 0, };
...
int main()
{
    ...
    fp_error = fopen("error_sum.pcm", "wb");
    ...
    //printf("for loop Elapsed time : %f  \n", (double)(end2 - start2));
